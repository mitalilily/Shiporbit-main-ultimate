    ...
    <Container maxWidth="lg" sx={{ py: 8 }}>
      <Box display={'flex'} justifyContent={'center'}>
        <PageHeading
          ...
          subtitle="All policies, terms, and privacy information for ShipOrbit"
        />{' '}
      </Box>
      ...
      <Box sx={{ mt: 6 }}>
        ...
        <Typography paragraph>
          â€¢ ShipOrbit (ShipOrbit Pvt Ltd) reserves the right to modify, suspend, or terminate
          the Service for any reason, without prior notice at any time.
        </Typography>
        <Typography paragraph>
          â€¢ Fraud Prevention: Without limiting any other remedies, ShipOrbit may suspend or
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Typography paragraph>
          ShipOrbit (ShipOrbit Pvt Ltd) ("we," "our," or "us") operates the services offered
