...
const shellCard = {
  ...
  background: '#ffffff',
  boxShadow: `0 12px 28px ${alpha(INK, 0.05)}`,
}
...
export default function Home() {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      note: 'Add balance so bookings and pickup flows do not stall.',
  ...
  return (
    <Stack spacing={{ xs: 3, md: 4 }} sx={{ pb: 5 }}>
      ...
      >
        <Box
          sx={{
            ...
            boxShadow: '0 22px 44px rgba(31, 49, 255, 0.18)',
          }}
        >
          <Stack spacing={2.6}>
            <Stack
            ...
            >
              <Box>
                ...
                >
                  ...
                  <strong style={{ color: '#FFFFFF' }}>{businessName}</strong>. Start with bookings,
                  keep the wallet active, watch pickup movement, and check which courier lanes are
                  carrying the load.
                </Typography>
              </Box>
              ...
              >
                <Button
                  ...
                  sx={{
                    ...
                    fontWeight: 800,
                    px: 3,
                    '&:hover': { background: alpha('#FFFFFF', 0.94) },
                  }}
                >
                  Create shipment
                </Button>
              ...
              {heroMetrics.map((metric) => (
                <Box
                  ...
                  sx={{
                    ...
                    border: `1px solid ${alpha('#FFFFFF', 0.18)}`,
                    boxShadow: '0 8px 18px rgba(10, 20, 80, 0.08)',
                  }}
                >
            ...
            <Box
              ...
              sx={{
                ...
                '&:hover': {
                  ...
                  boxShadow: `0 18px 32px ${alpha(INK, 0.08)}`,
      ...
      <Box>
        <SectionHeading
          title="Pickup Queue"
          subtitle="Track the live pickup pipeline so dispatch does not fall behind."
          icon={<TbTruckDelivery size={22} />}
          color={TEAL}
        />
        <Box sx={{ ...shellCard, p: { xs: 2, md: 2.5 } }}>
