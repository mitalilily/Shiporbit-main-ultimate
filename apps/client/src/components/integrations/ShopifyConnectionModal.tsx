            ...
            >
              ...
              <Stack spacing={2}>
                ...
                <CustomSwitch
                  ...
                  helperText="Automatically update order statuses in Shopify when they change in the ShipOrbit workspace."
                />
                ...
                <CustomSwitch
                  ...
                  helperText="Automatically cancel the order in Shopify when it’s marked as cancelled in the ShipOrbit workspace."
                />
