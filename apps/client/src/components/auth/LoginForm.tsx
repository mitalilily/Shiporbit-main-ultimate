...
const commandNotes = [
  'Sign in with your registered email to access your ShipOrbit account.',
          ...
          >
            <Stack spacing={2.4}>
              ...
              <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap>
                {['ShipOrbit platform', 'ShipOrbit brand colors', 'Secure login system'].map((chip) => (
                  <Box
                    key={chip}
                    sx={{
                      px: 1.35,
              ...
              <Stack spacing={1.3} sx={{ maxWidth: 650 }}>
                ...
                >
                  ...
                  and shipping operations in ShipOrbit.
                </Typography>
              </Stack>
            </Stack>
          ...
          <Box sx={{ width: '100%', maxWidth: 520, mx: 'auto' }}>
            <Stack spacing={2.1} sx={{ mb: 2.6 }}>
              ...
              <Stack spacing={0.8}>
                ...
                >
                  Sign in with OTP or password to access your ShipOrbit dashboard and account tools.
                </Typography>
              </Stack>
