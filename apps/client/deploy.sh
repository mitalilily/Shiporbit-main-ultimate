...
export VITE_API_URL="https://shiporbit-main-ultimate-production.up.railway.app/api"
export VITE_APP_SOCKET_URL="https://shiporbit-main-ultimate-production.up.railway.app"
